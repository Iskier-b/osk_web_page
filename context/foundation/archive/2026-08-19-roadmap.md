...
- **Outcome:** visitor can browse the full navigation structure; where body content is not copied yet, subsections show title-only / placeholder stubs (no empty dead-end links; no invented body copy).
...
| S-04       | representative-deep-path    | One representative deep path with real copied content | no                    | Archived / done                                   |
